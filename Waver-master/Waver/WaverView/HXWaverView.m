...
- (void)setup
{
    ...
    self.maxAmplitude = 20;//self.waveHeight - 4.0f;
}

- (void)setWaverLevelCallback:(void (^)(HXWaverView * waver))waverLevelCallback {
